 ...
 * @extends {ItemSheetV2}
 */
export class rt87ItemSheet extends api.HandlebarsApplicationMixin(
  sheets.ItemSheetV2
) {
  constructor(options = {}) {
    super(options);
  ...
  static PARTS = {
    header: {
      template: 'systems/rt87/templates/item/header.hbs',
    },
    tabs: {
    ...
    description: {
      template: 'systems/rt87/templates/item/description.hbs',
    },
    attributesFeature: {
      template:
        'systems/rt87/templates/item/attribute-parts/feature.hbs',
    },
    attributesGear: {
      template: 'systems/rt87/templates/item/attribute-parts/gear.hbs',
    },
    attributesSpell: {
      template: 'systems/rt87/templates/item/attribute-parts/spell.hbs',
    },
    effects: {
      template: 'systems/rt87/templates/item/effects.hbs',
    },
  };
